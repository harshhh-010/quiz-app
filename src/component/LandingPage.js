        ...
        <form class="md:px-40" onSubmit={handleSubmit}>
            ...
            <div className="sm:grid grid-cols-2 gap-2">
                <div class="mb-5">
                  ...
                  <input type="number" maxLength={10} minLength={10} id="first name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="0987654321" onChange={handleChange} required/>
